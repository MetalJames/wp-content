...
// }
// add_action( 'woocommerce_single_product_summary', 'clw_woocommerce_single_product_summury_subtitle', 2 );

// function clw_woocommerce_before_add_to_cart_quantity_test() {
